...
/// A locally-tracked open position, since Tabdeal Spot has no native
/// "position" concept (only orders + balances). We build the position
/// abstraction on top of a filled entry order + attached SL/TP orders.
class OpenPosition {
  final String id; // local UUID
  final String symbol;
  final OrderSide side; // buy = long-style spot position
